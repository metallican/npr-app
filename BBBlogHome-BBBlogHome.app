<aura:application controller="BB_LTG_BlogPostController" access="GLOBAL" >
    <aura:attribute name="blogWrappers" type="BB_LTG_BlogWrapper" />
    <aura:attribute name="empty" type="Boolean" default="false" />
    <ltng:require scripts="/resource/Picturefill_1_2_1"
                  styles="/resource/SLDS0121/assets/styles/salesforce-lightning-design-system-ltng.css" 
