({
 ...
 /*
      action.setParams({
         'pObjName': component.get("v.objInfo"),
         'pControllingFieldName': controllerField,
         'pDependentFieldName': dependentField
      });
      
      */
      action.setParams({
         'pObjName': 'Lead',
         'pControllingFieldName': 'Country',
         'pDependentFieldName': 'State'
      });
      //set callback   
